/**
 * @file non_standard_but_ok.c
 *
 * @brief Programa que determina si dos palabras son iguales o distintas
 *
 * @author  Hugo Gonzalez <hugo@hugo-VirtualBox>
 * @version 2023-11-19
 *
**/
 ...
 * @returns true or false, ya que es una funcion de tipo booleano
**/
